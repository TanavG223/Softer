...
Open `index.html` directly or run `python3 -m http.server 8000 --directory site`. Validate it with `python3 site/scripts/check_site.py`.

The JavaScript only updates the interactive need-to-activity example and reveal styling. It performs no network requests, tracking, or storage. External links open only after the visitor selects them.
