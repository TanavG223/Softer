...
[![Softer verification](https://github.com/TanavG223/Softer/actions/workflows/ci.yml/badge.svg)](https://github.com/TanavG223/Softer/actions/workflows/ci.yml)
[![GitHub release](https://img.shields.io/github/v/release/TanavG223/Softer)](https://github.com/TanavG223/Softer/releases/latest)
[![License](https://img.shields.io/github/license/TanavG223/Softer)](LICENSE)
...
- **Support:** U.S.-labeled 988/911 actions, an international directory, and confirmed controls that open Messages or Contacts remain static and model-independent. Softer never chooses a person or sends anything.
...
The current universal release supports Apple silicon and Intel Macs running macOS 14 or newer: [Softer releases](https://github.com/TanavG223/Softer/releases/latest).

This prototype is Apple Development-signed but not Developer ID notarized. After unzipping, Control-click **Softer.app**, choose **Open**, and confirm **Open**. If macOS still blocks it, use **System Settings → Privacy & Security → Open Anyway**. Verify the ZIP against the SHA-256 published with the release before opening it.

## Current Mac experience

![Softer Calm screen with one gentle activity and one-click Harbor Tiles](output/submission/softer-calm.png)

![Softer Play screen with two finite focus choices](output/submission/softer-play.png)

![The adjustable Gentle breathing visual pacer](output/submission/softer-breathing.png)

## Build and verify without Xcode

Softer targets macOS 14 and newer and uses the standalone Apple Command Line Tools. Node.js is also required for the JavaScript syntax check inside `make verify`:
...
The defensible product claim is: **Softer makes a small set of optional, evidence-informed activities easy to choose, stop, switch, or leave for human support.** Whether Softer itself reduces stress or improves wellbeing remains untested.
