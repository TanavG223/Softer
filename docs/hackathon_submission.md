...
Personalization is deliberately small and inspectable. It uses only the selected need and an optional “more settled / same / less settled” checkout, applies bounded deterministic adjustments, and cools down an activity after “less settled.” It does not use sensors, typing, gameplay, support actions, or an AI model.
...
1. Launch and show the one-action Calm screen.
2. Choose “Thoughts moving fast”; show the reason and alternatives.
3. Start and stop “Notice the room”; show that stopping is a valid ending.
4. Complete a few Harbor Tiles placements, then use Hint and Undo; show the exact finite endpoint.
5. Open Harbor Path; show Skip and Stop.
6. Submit one closed checkout and show the transparent local adaptation explanation.
7. Open Support and explain that no model, profile score, or feedback controls it.
8. End on Privacy/About with the explicit unvalidated-product boundary.
