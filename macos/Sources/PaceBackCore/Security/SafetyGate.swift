...
public enum DangerSign: String, CaseIterable, Codable, Identifiable, Sendable {
    ...
    public var isYoungChildSpecific: Bool {
        self == .inconsolableCrying || self == .refusesToNurseOrEat
    }
}

public enum SafetyGateResult: Equatable, Sendable {
    case clear
